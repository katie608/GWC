...
code for Python shapes 3 question 3:
...
This draws cool art: it draws all polygons triangle-decagon side by side and
goes through the colors of the rainbow and then draws enough of those rows to
fill a page and make cool art

from turtle import *
def draw_polygon(num_of_corners, color):
        pencolor(color)
        pendown()
        for i in range(num_of_corners):
                forward(200/num_of_corners)
                right(180-((180*(num_of_corners-2)/num_of_corners)))
...
def draw_polygon(num_of_corners, color):
        ...
        pendown()
        for i in range(num_of_corners):
                forward(500/num_of_corners)
                right(180-((180*(num_of_corners-2)/num_of_corners)))

colors=["red", "orange", "yellow", "green", "blue", "dark blue", "purple", "pink", "red", "orange", "yellow", "green", "blue", "dark blue", "purple", "pink", "red", "orange", "yellow", "green", "blue", "dark blue", "purple", "pink", "red", "orange", "yellow", "green", "blue", "dark blue", "purple", "pink"]

penup()
goto(-300, 300)
for i in range(100):
        draw_polygon(5, colors[i%8])
        penup()
        forward(1)
        right(90)
        forward(1)
